      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <ul className="hidden md:flex space-x-8 text-sm items-center">
            ...
            <li>
              <Link to="/createposts" className="text-white font-semibold px-3 py-2 rounded-lg hover:bg-gray-700 hover:text-yellow-300 transition">Post</Link>
            </li>
            <li>
        ...
        {menuOpen && (
          <div className="md:hidden mt-2 bg-gray-800 rounded-xl shadow-lg p-4 space-y-3">
            ...
            <Link to="/createposts" onClick={() => setMenuOpen(false)} className="block text-white hover:text-yellow-300">Post</Link>
